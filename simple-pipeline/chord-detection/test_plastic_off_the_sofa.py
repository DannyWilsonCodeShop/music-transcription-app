#!/usr/bin/env python3
"""
Test: Plastic Off The Sofa by Beyoncé
Contemporary R&B/Soul with rich harmony
"""
...
def main():
    audio_path = '../../public/08 PLASTIC OFF THE SOFA.m4a'
    
    print("=" * 80)
    print("TESTING: Plastic Off The Sofa by Beyoncé")
    print("Genre: Contemporary R&B/Soul")
    print("=" * 80)
    ...
    try:
        ...
        # Display results
        print("\n" + "=" * 80)
        print("RESULTS: Plastic Off The Sofa")
        print("=" * 80)
        ...
        # Save results
        output_path = '/tmp/plastic_off_the_sofa_results.json'
